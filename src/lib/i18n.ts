...
const pt: Dict = {
  ...
  focus_counts_in: "Também conta para {name} (ex.: “pelo menos 1 starter” inclui esta carta)",
  focus_badge: "Carta",
...
const en: Dict = {
  ...
  focus_counts_in: "Also counts toward {name} (e.g. “at least 1 starter” includes this card)",
  focus_badge: "Card",
...
const es: Dict = {
  ...
  focus_counts_in: "También cuenta para {name} (ej.: “al menos 1 starter” incluye esta carta)",
  focus_badge: "Carta",
